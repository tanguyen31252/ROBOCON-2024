...
#define LCD_D4_GPIO_CLK               	RCC_AHB1Periph_GPIOB
#define LCD_D4_GPIO_PIN               	GPIO_Pin_14

#define LCD_D5_GPIO_PORT            		GPIOB
#define LCD_D5_GPIO_CLK               	RCC_AHB1Periph_GPIOB
#define LCD_D5_GPIO_PIN               	GPIO_Pin_15

#define LCD_D6_GPIO_PORT            		GPIOD
#define LCD_D6_GPIO_CLK               	RCC_AHB1Periph_GPIOD
#define LCD_D6_GPIO_PIN               	GPIO_Pin_10

#define LCD_D7_GPIO_PORT            		GPIOD
#define LCD_D7_GPIO_CLK               	RCC_AHB1Periph_GPIOD
#define LCD_D7_GPIO_PIN               	GPIO_Pin_11
