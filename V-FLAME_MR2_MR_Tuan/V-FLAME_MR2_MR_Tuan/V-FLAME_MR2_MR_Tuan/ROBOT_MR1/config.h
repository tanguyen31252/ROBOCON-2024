...
#define Mor_Mam_thuan					 								DATA_SPEED[18]=0
#define Mor_Mam_nghich												DATA_SPEED[18]=1
#define	Mor_Mam 		 													DATA_SPEED[19]

#define	DIA_CHI_START7											  DATA_SPEED[20]=255
#define	ID6																    DATA_SPEED[21]=6
#define Mor_TrucY_thuan					 							DATA_SPEED[22]=1
#define Mor_TrucY_nghich											DATA_SPEED[22]=0
#define	Mor_TrucY 		 												DATA_SPEED[23]


#define	DIA_CHI_START6												DATA_SPEED[24]=255
#define	ID7	 																	DATA_SPEED[25]=7
#define Mor_TrucX_thuan					 							DATA_SPEED[26]=0
#define Mor_TrucX_nghich											DATA_SPEED[26]=1
#define	Mor_TrucX 		 												DATA_SPEED[27]
...
//================================INPUT - NUT NHAN ==================================//
#define  NUT_RUN_RB					GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0) // Nut green -- OK
#define  NUT_STOP						GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2) // Nut YELLOW
#define  NUT_RESET					GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_1) // Nut RED
#define  NUT_CHUYEN_SAN			GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_15) // --OK

#define  CB_NHAN_BONG				GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3) 


//================================OUTPUT - XILANH ==================================//
#define  XI_LANH_LUA_BONG_ON								  GPIO_WriteBit(GPIOB,GPIO_Pin_6,1)
#define  XI_LANH_LUA_BONG_OFF								GPIO_WriteBit(GPIOB,GPIO_Pin_6,0)

#define  XI_LANH_NANG_BONG_ON							  	GPIO_WriteBit(GPIOB,GPIO_Pin_7,1)
#define  XI_LANH_NANG_BONG_OFF									GPIO_WriteBit(GPIOB,GPIO_Pin_7,0)

#define  XI_LANH_KEP_BONG_ON						  		GPIO_WriteBit(GPIOB,GPIO_Pin_10,1)
#define  XI_LANH_KEP_BONG_OFF									GPIO_WriteBit(GPIOB,GPIO_Pin_10,0)
...
int Min_BT_mam_xoay = 15;
int Max_BT_mam_xoay = 560; 
int taget_BT_mam_xoay = 560;

int Min_BT_trucX = 60;
int Max_BT_trucX = 300; //220
int taget_BT_trucX = 220;
	
int Min_BT_trucY = 70;
int Max_BT_trucY = 630;
int taget_BT_trucY= 500;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 6:
										...
										break;
									case 7:
										HMI_DMI("BIEN TRO X:",bien_tro_nang_trucX,7);
										break;
									case 8:
