...
//	else
//  {
//		lazeSauTraiValue = lazeTruoc_SUM/50;
//		lazeTruocCouter = 0;
//		lazeTruoc_SUM = 0;
//	}
////------------------------	
...
//																															vTaskDelay(1);}
//	
//	for(i=0;i<10;i++)	while((lazeSauTraiValue > distance))		{		cap_thanh_lazer_sau_phai(120, 12);
//																																															if(wantExit() == 1) break;	
//																																															vTaskDelay(1);}					
...
//																															vTaskDelay(1);}
//	
//	for(i=0;i<10;i++)	while((lazeSauTraiValue > distance))		{	cap_thanh_lazer_sau_trai(120, 12);
//																																														if(wantExit() == 1) break;	
//																																														vTaskDelay(1);}
//	RESET_ENCODER();
//																																															
