...
int LAZENGANG_2[2][7]   =               {           //1     //2     //3     //4     //5     //6    
                                            {0,     272,    222,    172,    122,    72,    22},                              	//san xanh
                                            {0,     215,    265,    315,    365,    415,    465},                               	//san do
                                        }; 
/******************************************************	DOC SAN 2				***************************************************/
int LAZEDOC_2[7]		=               {	 0,     210,    260,    310,    360,    410,    460};
/******************************************************	TOC DO BAN 				**************************************************/
int tocdo[2][6]         =               {   //1     //2     //3     //4     //5     //6
                                            {125,   125,    125,    125,    125,	125} ,      //ban thoc
                                            {123,   123,    123,    123,    123,    123},         //ban lep
};
 
/***************************************************** GIAM AP PHE				*************************************************/
int giamphe[2][6]		=				{
											{74,74,	80,	74,	74,	74},							//phe thoc
											{85,85,	90,	85, 92,85} ,				//phe lep
										};
