...
/**************************CHAY 3 LAN DAU**************************/
    if(bien_ve_xuat_phat < 3)
    {
        ...
        if(NUT_CHUYEN_SAN == 1)
        {
            robotRunAngle(800, 30, -1200, 1.3);
            while (robotAngle() > -1200){}

            RESET_ENCODER();
            robotRunAngle (900, 50, -1000, 1.3);
            while (ENCODER_FL() < 1400){}
        ...
        {    
            robotRunAngle(-900, 50, 550, 2);
            while (robotAngle() < 400){}

            RESET_ENCODER();
            robotRunAngle (-900, 50, 550, 1);
